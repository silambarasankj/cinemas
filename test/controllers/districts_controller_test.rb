...
class DistrictsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create district" do
    assert_difference('District.count') do
      post districts_url, params: { district: { name: @district.name, state_id: @district.state_id, status: @district.status } }
    end
  ...
  test "should update district" do
    patch district_url(@district), params: { district: { name: @district.name, state_id: @district.state_id, status: @district.status } }

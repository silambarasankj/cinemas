...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { image: @gallery.image, purpose_type: @gallery.purpose_type, status: @gallery.status, user_id: @gallery.user_id } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { image: @gallery.image, purpose_type: @gallery.purpose_type, status: @gallery.status, user_id: @gallery.user_id } }
